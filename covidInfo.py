...
def state_wise(table_row):
    ...
    warn_message = Label(root, font=('lucida', 12, 'bold'), fg="red")
...
if __name__ == '__main__':
    ...
    title = Label(root, text="Covid Info - India(State Wise)", font=('lucida', 20), bg=bg, fg=fg)
    ...
    footer = Label(root, text="Copyrights - THE_ARYA 2020", anchor=CENTER, fg="BLACK", bg="#99b3e6")
